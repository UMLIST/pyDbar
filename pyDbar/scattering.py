...
def approx_scatter(k_grid: KGrid,
    ...
    using the specified pointwise solver. The tolerance is
    used to define the support of the solution.

    Note: approx_scatter() also accepts kwargs to be passed in
    to the pointwise_solver function, but DON'T pass in point k
    as it will be generated by this function.
    """
    grid = k_grid.grid
